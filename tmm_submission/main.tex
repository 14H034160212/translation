...
%% The qualitative-examples discussion contains Chinese/Japanese characters
%% rendered via the xeCJK package, which REQUIRES the XeLaTeX engine.
%% pdfLaTeX will fail on these characters. Build sequence:
