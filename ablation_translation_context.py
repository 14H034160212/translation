...
def generate_translation_with_vision(model, processor, text, video_path):
...
def run_ablation(data_dir, video_dir, output_file, model_path=MODEL_PATH):
    ...
    print(f"Visual Context BLEU: {bleu.score:.4f}  chrF++: {chrf.score:.4f}")
